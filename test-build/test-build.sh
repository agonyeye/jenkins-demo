...
./rancher-compose --access-key EF156F5D22D46A81D9B0 --secret-key QMGwZjWJqNaV8F7aiETmzWRo6zJnarBBKzSzUJoh up --pull  -d --confirm-upgrade  --upgrade python-redis-demo-build${BUILD_NUMBER}
